...
const UserInfo = ({ user, onUserInfoChange }) => {
  ...
  return (
    <div>
      ...
      <Button variant="contained" color="primary" style={{ marginTop: '20px' }} onClick={handleSaveChanges}>
        Save Changes
      </Button>

      {/* Display Toast Notification */}
      {toastMessage && <ToastNoti message={toastMessage} type={toastType} position="top-right" autoClose={3000} />}
    </div>
  );
};
