...
const SearchPage = () => {
	...
	useEffect(() => {
		...
		if (priceRange === "below_3") queryParams.append("maxPrice", 3000000);
		if (priceRange === "3_5") {
			queryParams.append("minPrice", 3000000);
		...
		if (priceRange === "above_20") queryParams.append("minPrice", 20000000);
	...
	useEffect(() => {
		...
		if (priceRange) {
			if (priceRange === "below_3") {
				filteredResults = filteredResults.filter((item) => item.price < 3000000);
				...
				filteredResults = filteredResults.filter((item) => item.price > 20000000);
			}
		}
