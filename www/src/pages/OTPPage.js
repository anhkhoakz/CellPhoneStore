		...
		>
			...
			{isOtpSent ? (
				<Typography variant="body2" align="center" gutterBottom>
					A 6-digit OTP has been sent to your email. Please check your inbox and enter the code below.
				</Typography>
			) : (
				<Typography variant="body2" align="center" sx={{ color: red[500] }} gutterBottom>
			...
			<Link href="#" variant="body2" onClick={handleResendOtp} sx={{ alignSelf: "center", cursor: "pointer" }}>
				Resend OTP
			</Link>
		</Box>
	);
