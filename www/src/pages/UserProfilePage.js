...
const UserProfilePage = () => {
	...
	const handleAddAddress = (newAddress) => {
		setUser((prevUser) => ({
			...prevUser,
			addresses: [...prevUser.addresses, { id: prevUser.addresses.length + 1, isDefault: false, ...newAddress }],
		}));
	...
	return (
		...
		>
			...
			<Grid item xs={12} md={6}>
				<Paper elevation={3} sx={{ padding: "1.25em", width: "80vh", maxWidth: "80vh" }}>
			...
			{toast.show && (
				<ToastNoti message={toast.message} type={toast.type} position="top-right" autoClose={3000} />
			)}
		</Grid>
	);
};
