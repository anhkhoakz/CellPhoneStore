...
import OrderDetailDialog from './modal/OrderDetailDialog';
import CanceledReasonDialog from './modal/CanceledReasonDialog';
...
const createData = (orderId, customerName, totalAmount, orderStatus, orderDate, note, items) => {
  return { orderId, customerName, totalAmount, orderStatus, orderDate, note, items };
};

const initialRows = [
  createData('ORD123', 'John Doe', 250, 'Pending', '2024-11-07', '', [
    { name: 'Product A', amount: 2, price: 50, image: 'https://via.placeholder.com/100' },
    { name: 'Product B', amount: 1, price: 150, image: 'https://via.placeholder.com/100' }
  ]),
  createData('ORD124', 'Jane Smith', 100, 'Shipped', '2024-11-06', '', [
    { name: 'Product C', amount: 1, price: 100, image: 'https://via.placeholder.com/100' }
  ]),
  createData('ORD125', 'Alice Johnson', 450, 'Delivered', '2024-11-05', '', [
    { name: 'Product D', amount: 3, price: 150, image: 'https://via.placeholder.com/100' }
  ]),
  createData('ORD126', 'Bob Brown', 300, 'Pending', '2024-11-04', '', [
    { name: 'Product E', amount: 2, price: 150, image: 'https://via.placeholder.com/100' }
  ]),
  createData('ORD127', 'Charlie White', 150, 'Canceled', '2024-11-03', 'Customer request', [
    { name: 'Product F', amount: 1, price: 150, image: 'https://via.placeholder.com/100' }
  ])
];
